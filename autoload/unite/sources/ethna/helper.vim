...
"
function! unite#sources#ethna#helper#gather_candidates_cmd(command, arguments)
...
"
function! unite#sources#ethna#helper#gather_candidates_cmd_input(command, arguments) 
  return map(a:arguments , '{
        \ "word" : v:val.word ,
        \ "abbr" : get(v:val, "abbr", v:val.word) ,
        \ "kind" : "command" ,
...
function! s:create_cmd_input(cmd, word, abbr)
  return "call unite#sources#ethna#helper#execute_cmd_input('". a:.cmd . "','" . a:word . "','" . a:abbr . "')"
endfunction
"
"
function! unite#sources#ethna#helper#execute_cmd_input(cmd, word, abbr)
...
function! s:execute_cmd()
  if g:unite_ethna_execute_cmd == '!'
    return '!'
  else
    return g:unite_ethna_execute_cmd . ' '
  endif
endfunction


"
" get ethna root directory
"
function! unite#sources#ethna#helper#ethna_root()
